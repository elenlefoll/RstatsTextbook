...
[^index-1]: A list of next-step resources can be found in the [Appendix](https://elenlefoll.github.io/RstatsTextbook/A_FurtherResources.html).
...
## Acknowledgements [`r emoji("purple_heart")`]{.content-visible when-format="html"}
...
If you've spotted an error or if you have any other suggestion to improve this resource, I would love to hear from you, too. [`r emoji("envelope")`️](mailto:elefoll@uni-koeln.de)
...
![Artwork encouraging beginner `R` learners by [\@allison_horst](https://allisonhorst.com/allison-horst) CC-BY 4.0.](images/AHorst_RLearnersWeBelieve.png){#fig-WeBelieveinYou fig-alt="Header text saying 'R learners' above five friendly-looking monsters holding up signs that together read “we believe in you.”" width=70%}