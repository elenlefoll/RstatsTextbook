...
This open textbook is currently **work in progress**. The main part will consist of 15 content chapters, each featuring hands-on tasks and interactive quizzes to immediately apply the content of the chapters to real linguistic datasets.
...
This textbook was partly designed on the basis of materials that I have developed for these courses and workshops. Publishing these materials is my way to contribute to the wonderful community of people who have helped me on my lea`R`ning journey. `r emoji("hugging_face")`️
