...
![Artwork encouraging beginner `R` learners by [\@allison_horst](https://allisonhorst.com/allison-horst) CC-BY 4.0.](images/AHorst_RLearnersWeBelieve.png){#fig-WeBelieveinYou fig-alt="Header text saying 'R learners' above five friendly-looking monsters holding up signs that together read “we believe in you.”"}
