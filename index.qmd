...
This textbook is intended to be read linearly, chapter by chapter. Apart from the first introductory chapter, all other chapters will require several hours of commitment. They include quiz questions and short practical tasks. Completing the these questions and tasks is essential to genuinely assimilate the textbook's contents. That's because the best way to learn new skills is to try things out so, with this in mind, let's get cracking!
