...
[**a.**]{style="color:green;"} For which kinds of studies could these different types of data have been collected? Think about both experimental and observational studies.

[**b.**]{style="color:green;"} Which of these data types is most likely to be measured in milliseconds (ms)?
...
[**a.**]{style="color:green;"} In which file format are these Playmobil image files?
...
[**b.**]{style="color:green;"} How wide are these Playmobil images in pixel?
...
[**a.**]{style="color:green;"} Has the proportion of genetics publications with Excel gene lists affected by auto-formatting errors decreased since 2016?
...
[**b.**]{style="color:green;"} Does using LibreOffice Calc (see @sec-OpenSource) also cause these same issues?
...
[**c.**]{style="color:green;"} Did highly reputable journals publish fewer articles with erroneous Excel gene lists?
