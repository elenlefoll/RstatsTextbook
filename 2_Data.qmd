...
::: column-margin
![[ ](https://www.re3data.org/)](images/logo_re3data.png){width="150" alt-text="The re3data logo which are the letters RE to the power of three because these two letters appears three times in the full name: registry of research data repositories."}
:::
::::
...
![Image from Experiment 1 in @schimkeFirstLanguageInfluence2018](images/Playmobil.png){#fig-Playmobil fig-alt="Photo of two Playmobil figures. On the left, a street sweeper with a broom and, on the right, a postman with a trolley." width="400"}
