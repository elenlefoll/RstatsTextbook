...
[**Q2.1**]{style="color:green;"} Which other reasons could potentially jeopardise the comparison of test results data from two different groups of pupils?
...
[**Q2.2**]{style="color:green;"} In which format are Microsoft Word files typically saved?

```{r Format-question, echo=FALSE}
...
[**Q2.3**]{style="color:green;"} Which of these files are audio files?

```{r Format-question2, echo=FALSE}
...
[**Q2.4**]{style="color:green;"} What is the separator character in the file `offlinedataLearners.txt`?
...
[**Q2.5**]{style="color:green;"} What is the delimiter character in the file `offlinedataLearners.txt`?
...
[**Q2.6**]{style="color:green;"} How many observations does the file `offlinedataLearners.txt` contain?
...
[**Q2.7**]{style="color:green;"} In this table, what does each observation correspond to?
...
You have successfully completed [`r checkdown::insert_score()` out of 7 quiz questions]{style="color:green;"} in this chapter.

Are you confident that you can...?

-   [ ] Distinguish different types of research data (@sec-ResearchData)
-   [ ] Distinguish different formats of data and file extensions (@sec-FileExtensions)
-   [ ] Work with DSV files and open them in LibreOffice Calc (@sec-DSV) - (@sec-DSVLibreOffice)
