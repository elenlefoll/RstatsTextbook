...
+------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Open materials**                                                                                         | Giving free, unrestricted, public access to research materials in a way that allows others to replicate the results of published studies and to conduct new studies based on these existing materials.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ![](images/OpenMaterials.png){fig-alt="Open materials badge showing an open box" width="60%"}              | Materials may include questionnaire items, all kinds of experimental stimuli, annotation schemes, inclusion and exclusion criteria, etc. (see Task 2 in @sec-Sharing).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|                                                                                                            | ::: {.content-visible when-format="pdf"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|                                                                                                            | ![](images/whitespace.png){width="30%"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                            | :::                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
+------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Open data**                                                                                              | Giving free, unrestricted, public access to scientific data, whenever ethically and legally possible [see @berez-kroekerOpenHandbookLinguistic2022]. An important principle of Open Science is the sharing of FAIR data; that is data that are Findable, Accessible, Interoperable, and Reusable.                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ![](images/OpenData.png){fig-alt="Open data badge showing a bar chart" width="60%"}                        | In @sec-DataLanguageSciences, we will see that studies in the language sciences can involve many different types of data including texts, tables, images, and videos.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|                                                                                                            | ::: {.content-visible when-format="pdf"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|                                                                                                            | ![](images/whitespace.png){width="30%"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                            | :::                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
+------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Open code**                                                                                              | Making computer code freely and publicly available with appropriate documentation to make research methods and data analyses transparent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ![](images/OpenCode.png){fig-alt="Open data badge showing a forward slash in angled brackets" width="60%"} | Open code can include source code for custom software and packages, code for stimuli generation, data collection and processing, statistical analysis, and data visualisation. Sharing code allows for collaborations, while sharing both code and data allows others to reproduce published results.                                                                                                                                                                                                                                                                                                                                                                                                                              |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|                                                                                                            | ::: {.content-visible when-format="pdf"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|                                                                                                            | ![](images/whitespace.png){width="30%"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                            | :::                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
+------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Open access**                                                                                            | Giving free, unrestricted, public access to scientific outputs, foremost publications. Contrary to a frequent misunderstanding, authors or their institutions do not necessarily have to pay article processing fees ([APC](https://forrt.org/glossary/english/article_processing_charge/)s) to publish their work in open access. Publishing open access can instead involve uploading a pre-copyedit version of a publication on a public repository (see @sec-Sharing) or publishing in a so-called 'diamond' (typically non-profit) open access publication outlet [see section on [Open Access](https://book.the-turing-way.org/reproducible-research/open/open-access.html) in @theturingwaycommunityTuringWayHandbook2022]. |
|                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ![](images/OpenAccess.jpg){fig-alt="Open access symbol showing an open lock" width="60%"}                  | ::: {.content-visible when-format="pdf"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|                                                                                                            | ![](images/whitespace.png){width="30%"}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                            | :::                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
+------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
wrong = "No, this software is not open source. The source code is not available to all. Please try again.")
```
...
wrong = "No, this software is proprietary. Please try again.")
```
...
wrong = "No, just like `R`, this programming language is also open source. Please try again.")
```
...
wrong = "No, this operating system is not open source. It is owned by Apple. Please try again.")
```
:::
::::

:::: {.callout-important collapse="false"}
#### Installing LibreOffice {.unnumbered}

To complete the tasks of this textbook, you will need to [download](https://www.libreoffice.org/download/download-libreoffice/) and [install](https://www.libreoffice.org/get-help/install-howto/) the open-source software suite **LibreOffice**. This is important as we will use its spreadsheet editor, **LibreOffice Calc**, in the following two chapters.

::: {.content-visible when-format="html"}
![](images/LibreOffice_logo.png){fig-alt="Libre Office logo" width="200"}
:::
...
It's up to you which version you prefer to work with. If you already have LibreOffice installed on your computer, now is a good time [to check that your version is up-to-date](https://help.libreoffice.org/latest/en-US/text/shared/01/online_update.html?DbPAR=SHARED).
...
![OER sketch note CC BY 4.0 [Yvonne Stry](https://leko.th-nuernberg.de/portal_digitale_lehre/praxisbeispiele/lehrmaterialien-teilen-fuer-flexibles-lernen/)](images/oer.jpg){#fig-OER fig-alt="Sketchnote graphic about Open Educational Resources" width="80%"}
...
check_question("Yes, but you must mention the name of the artist.",
               ...
               right = "That's right!",
               wrong = "No, that's not what the CC BY license means. Please try again.")
```
...
In this introductory chapter, we have simplified things considerably. To be considered open source, software distributions actually have to comply with [ten criteria](https://opensource.org/osd). To find out more about the benefits of open-source software in the context of research [The Turing Way](https://book.the-turing-way.org/reproducible-research/open/open-source) is a great place to start.
...
Head over to the online appendix to complete this chapter's [tasks and quizzes](https://elenlefoll.github.io/RstatsTextbook/quizzes/1_quiz.html). This is a great opportunity to consolidate what you have learnt so far and you will get immediate feedback on your progress.
:::
