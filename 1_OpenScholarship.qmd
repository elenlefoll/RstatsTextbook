...
In line with the principles of Open Education, all of the datasets used as case studies in this textbook have been published in open access. This means that we can use real data from published research studies in the fields of applied linguistics and language education to learn about data management and analysis.

::: callout-tip
#### Quiz time!

5\) Is it possible to reuse @fig-OER on a company website?
...
6\) Which of these resources can be released as OERs?
