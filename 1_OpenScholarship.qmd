...
+--------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+
| **Open data**      | Giving free, unrestricted, public access to scientific data, whenever ethically and legally possible [see @berez-kroekerOpenHandbookLinguistic2022].                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | ![](images/OpenData.png){fig-alt="Open data badge showing a bar chart"}                        |
|                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |                                                                                                |
...
Using open-source software in this introductory textbook means that anyone[^1_openscholarship-2] can download, install and use the required software at no cost. However, it is very important to note that not all free software ('freeware') is open source.
...
@sec-AppendixA also includes a list of recommended next-step OERs on data management, data analysis in `R`, statistics, data visualisation, Open Science, and reproducibility.
:::
...
-   [ ] Define open science (@sec-OpenScience)
-   [ ] Check if a software or a programming language is open-source (@sec-OpenSource)
-   [ ] Define the principles of Open Education (@sec-OpenEducation)
