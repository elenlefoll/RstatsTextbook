...
> upload (for contributions) and download (for use). [@IRIS2011]
...
check_question(answer = c("Reaction times", "reaction times", "Reaction time", "Reaction Time", "Reaction Times", "reaction", "Reaction"), 
