...
#section-bibliographies:
  #bibliography: RoseGina_references.bib
---

# The semantics of emojis: Explo`R`ing the results of an experimental study {toc-text="Short title"}
...
![Example of a test item in the experiment [from @fricke2024semantic: 6, CC-BY]](images/RoseGina_Fricke_test_items.png){#fig-testitems fig-align="center" width="500"}
...
![Screenshot from the authors' analysis script available at <https://osf.io/k8dtp>](images/RoseGina_disappointment_script_fricke.png){#fig-script fig-align="center" width="600"}
...
![Plot of individual emoji pairs that compares AU conditions [@fricke2024semantic: 11, CC-BY]](images/RoseGina_Fricke_AUplot.png){#fig-AUFricke width="700"}
