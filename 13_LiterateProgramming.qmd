...
-   sharing and publishing your research in different formats including HTML, PDF, LibreOffice Write, and Microsoft Word.
...
For the number of female L2 participants, however, it's not so simple because some are labelled `f`, while others are labelled `F` (see Task 9.1 in @sec-across).
