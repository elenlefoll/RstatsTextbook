...
-   [ ] Explain the concepts of literate programming and reproducible research to a friend or colleague
-   [ ] Write and format text (bold, first-level heading, italics, etc.) in a Quarto document
-   [ ] Insert code chunks in a Quarto document and make use of inline code
-   [ ] Insert tables in a Quarto document
-   [ ] Embed images and plots in a Quarto document
-   [ ] Render (i.e. export) your `.qmd` document to HTML, Microsoft Word, and PDF
