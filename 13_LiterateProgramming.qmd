...
-   [ ] Define concepts of literate programming and reproducible research (@sec-LiteRateProgramming)
-   [ ] Install Quarto, open a new Quarto document in RStudio and write and format text in Quarto (bold, first-level heading, italics, etc.) (@sec-StartQuarto) and (@sec-Markdown)
-   [ ] Insert a code chunk in a Quarto document and use inline codes (@sec-Chunks) and (@sec-Inline)
-   [ ] Construct a table in a Quarto document and embed images and plots (@sec-QuartoTables) and (@sec-QuartoFigures)
