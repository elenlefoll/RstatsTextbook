...
We will be writing Quarto documents from the *RStudio* IDE[^13_literateprogramming-3]; however, Quarto itself requires a separate installation. Follow these steps to **install** Quarto and check that everything is working as expected:
