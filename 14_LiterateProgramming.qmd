...
::: callout-caution
#### [**Task 14.1**]{style="color:green;"} {.unnumbered}
...
#### Click here for the solution to [**Task 14.1**]{style="color:green;"}
...
As you discovered in [**Task 14.1**]{style="color:green;"}, writing and formatting text in RStudio's Visual editor is very similar to writing in a word-processing software such as LibreOffice Writer or Microsoft Word. In the background, however, RStudio converts all formatting to **Markdown**.
...
Switch to the **Source mode** to view the text that you formatted in the Visual editor in [**Task 14.1**]{style="color:green;"} in Markdown format.

[**Q14.4**]{style="color:green;"} How is text highlighted in bold displayed in Markdown?
...
[**Q14.5**]{style="color:green;"} How is a first-level heading displayed in Markdown?
...
[**Q14.6**]{style="color:green;"} How are block quotes formatted in Markdown?
...
[**Q14.7**]{style="color:green;"} How will the word `~~mystery~~` be formatted in Markdown?
...
[**Q14.8**]{style="color:green;"} What is the output of the `setup` chunk in your rendered `.html` document?
...
[**Q14.9**]{style="color:green;"} Which code chunk option can you use to remove the two messages from the rendered version of your Quarto document, whilst still ensuring that the `setup` chunk is displayed and executed (so that the libraries can be used in future code chunks)?
...
[**Q14.10**]{style="color:green;"} Which code chunk option can you use to remove both the `setup` chunk and its outputs from the rendered version of your Quarto document, whilst still ensuring that the libraries are loaded so that their functions can be used further down in the document?
...
::: callout-caution
#### [**Task 14.2**]{style="color:green;"} {.unnumbered}
...
::: {.callout-note collapse="true"}
#### Click here for the solution to [**Task 14.2**]{style="color:green;"}
...
[**Q14.11**]{style="color:green;"} Compare the rendered version of your document with the original descriptive statistics reported in Dąbrowska [@DabrowskaExperienceAptitudeIndividual2019: 6]. Could you successfully **reproduce** these descriptive statistics? Which values are different?
...
::: callout-tip
#### [**Task 14.3**]{style="color:green;"} {.unnumbered}
...
:::: {.callout-note collapse="true"}
#### Click here for the solution to [**Task 14.4**]{style="color:green;"}
