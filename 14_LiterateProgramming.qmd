...
# Rep`R`oducible Research in Quarto {#sec-LiteRateProgramming}
...
[^13_literateprogramming-1]: Although there is ground for optimism here because more and more linguists and education scholars are beginning to make their data open in repositories such as the Open Science Framework (OSF), IRIS, and TROLLing (see @sec-Sharing).
...
::: callout-warning
#### Hiding code chunks in specific formats
