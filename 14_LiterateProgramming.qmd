...
::: {.content-visible when-format="pdf"}
### Check your progress {.unnumbered}
It's time to test your understanding of literate programming as implemented in Quarto. Head over to the online appendix to complete this chapter's [tasks and quizzes](https://elenlefoll.github.io/RstatsTextbook/14_quiz.html). Good luck! `r emoji("four_leaf_clover")`
