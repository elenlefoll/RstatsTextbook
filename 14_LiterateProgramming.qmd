...
-   Thinking of writing an entire M.A./PhD thesis or book in Quarto? Cameron Patrick wrote his PhD thesis in Quarto and has helpfully put together some [great tips](https://cameronpatrick.com/post/2023/07/quarto-thesis-formatting/.) so that his "pain and suffering can help reduce yours". Well worth reading if you're thinking of rendering a complex (set of) Quarto document(s) to PDF.

-   Last but not least, the 2^nd^ edition of "[R for Data Science](https://r4ds.hadley.nz/communicate)" also has a great chapter on communicating the results of data science projects using Quarto.
:::
