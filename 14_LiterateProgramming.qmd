...
![Creating a new Quarto document](images/Quarto_new.png){#fig-QuartoNew width="401"}{#fig-alt: "A screenshot of the new document settings in Quarto. The format selected is HTML as opposed to PDF or Word Document, no engine is selected, and visual markdown editor is not enabled."}
...
::: {layout-ncol="2"}
![The `.qmd` file as opened in RStudio](images/LearningQuarto_qmd.png){#fig-QuartoRender}{#fig-alt: "A screenshot of the .qmd file opened in RStudio. "Render" has been circles in the top bar, and the window displays the following text: title, learning quarto, subtitle, by reproducing the descriptive statistics of Dabrowska's (2019) study, author, Elen Le Foll, date, last modified."}
...
#| fig-cap: "A scatter plot relating vocabulary and collocation test scores. The dots are coloured according to occupational group. A slightly upward sloping regression line cuts through the dots, indicating a positive correlation."
#| fig-height: 5
#| fig-asp: 0.618
#| message: false
#| echo: fenced
