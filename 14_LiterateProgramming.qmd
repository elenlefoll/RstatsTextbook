...
1.  Using the keyboard shortcut Cmd/Ctrl + Alt/Option + i
...
-   the entire code chunk either by clicking the "Run"![](images/notebook-run-chunk.png)icon or with shortcut Shift + Cmd/Ctrl + Enter.
