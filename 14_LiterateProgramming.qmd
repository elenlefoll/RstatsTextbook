...
:::: {#fig-scatterplot-plotly .content-visible when-format="pdf"}

![Screenshot of the interactive plot of L2 participants' lexical proficiency in English](images/IntPlotCh14a.png)
