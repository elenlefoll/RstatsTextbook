...
-   the entire code chunk either by clicking the "Run"![](images/notebook-run-chunk.png)icon or with shortcut {{< kbd mac=Shift-Cmd-Enter win=Shift-Ctrl-Enter linux=Shift-Ctrl-Enter >}}.
