...
2.  Then, create a new Quarto document by navigating to *File \> New File \> Quarto Document...*, or clicking on the "new document" button and selecting "*Quarto Document..."*. A dialogue menu will appear (@fig-QuartoNew). Leave everything as is and simply click on "Create" at the bottom.
