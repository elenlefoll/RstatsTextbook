...
::: callout-note
A standalone version of this chapter is available as an [interactive webpage](https://elenlefoll.quarto.pub/quarto4research/) and in a downloadable [PDF](https://elenlefoll.quarto.pub/quarto4research/Quarto4Research.pdf) version. It is entitled *Quarto for reproducible research workflows and academic publishing: A step-by-step tutorial* [@lefollQuartoReproducibleResearch2026] and, unlike the present chapter which assumes that you have read prior chapters, has no prerequisites.
:::
...
![Search menu for bibliographic reference](images/Quarto_citation.png){#fig-QuartoCitation fig-alt="A screenshot of the citations window in RStudio. \"dabrowska\" has been entered in the search bar, and the 2019 study has been selected, generating a citation below."}
