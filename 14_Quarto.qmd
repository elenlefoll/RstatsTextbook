...
If we want to start our paragraph with 90 written as a word rather than in digits, we can use the `numbers_to_words()` function from the {xfun} package. First, you'll need to install the {xfun} package and then add a line to your `setup` chunk to load it.[^14_quarto-8]
