...
check_question("R returns an error message because it interprets the word as an object name or command.", 
               ...
               right = "That's right. Without quotation marks, character strings are interpreted by `R` as the name of an object or function.",
...
[^5_gettingstarted-1]: In the [online version](https://www.larousse.fr/dictionnaires/francais/%C3%A9cogeste/192366) of the *Larousse* dictionary (accessed 5 May 2026), *écogeste* is defined as: "Habitude simple que chacun peut adopter dans la vie de tous les jours afin de protéger l'environnement (réduire et trier ses déchets, ne pas laisser couler l'eau, éteindre la lumière, acheter ses aliments en vrac, etc.)" \[Simple habits that anyone can incorporate in their daily life to protect the environment (reducing and sorting waste, turning off lights and taps, buying non-packaged food, etc.)\].
