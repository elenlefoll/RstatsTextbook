...
::: {#fig-ConsoleInput layout="[[40,-1,40], [100]]"}
...
:::: {.content-visible when-format="pdf"}
::: callout-tip
If you're feeling lazy or simply want to avoid making a typo, you can type just the first few letters of an object name and then press the `Tab` key. *RStudio* will then give you a drop-down menu with possible options. Select the one you want by clicking on it or pressing "Enter".
:::
::::
...
::: {#fig-ObjectCalls layout="[[40,-1,40], [100]]"}
...
![Incomplete function in console](images/ConsoleUncompleteFunction.png){#fig-ConsoleIncompleteFunction fig-alt="RStudio screenshot showing the console with an incomplete function and a red ellipse around the +-symbol." width="60%"}
