...
-   Keep your cool when errors pop up! `r emoji("smiling-face-with-sunglasses")`
...
Earlier on, you created an object called `word2` which contained the string "cheerful". But, by running this new line of code, "cheerful" has been replaced by the string "surprised" - with no warning that you were about to permanently delete "cheerful"! `r emoji("astonished-face")`
...
## Dealing with errors `r emoji("cursing-face")` {#sec-Errors}
