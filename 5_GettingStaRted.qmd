...
![Incomplete function in console](images/ConsoleUncompleteFunction.png){#fig-ConsoleIncompleteFunction fig-alt="RStudio screenshot showing the console with an incomplete function and a red ellipse around the +-symbol." width="70%"}
...
![Error message in console](images/ConsoleError.png){#fig-ConsoleError fig-alt="RStudio screenshot showing the console with an error." width="70%"}
