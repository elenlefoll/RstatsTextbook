...
![Using the `R` Console as a calculator](images/ConsoleInputMathematicalOperations.png){#fig-ConsoleInputMathematicalOperations fig-alt="RStudio screenshot showing the console with the input of multiple mathematical operations." width="70%"}
