...
The web-based version of this textbook is published as an Open Educational Resource (OER) under the Creative Commons license: [`CC BY-NC-SA`](https://creativecommons.org/licenses/by-nc-sa/4.0/). This means that it is free to read and use, as well as edit, remix, and expand upon, provided that a) the original author and source is mentioned (as indicated by [`BY`](https://creativecommons.org/licenses/by-nc-sa/4.0/)), b) any derived version is not made into a commercial product ([`NC`](https://creativecommons.org/licenses/by-nc-sa/4.0/) stands for non-commercial), and c) that any derived versions of this textbook (e.g., a translated version or a version adapted for historians) are also shared with this same license ([`SA`](https://creativecommons.org/licenses/by-nc-sa/4.0/) stands for share alike).
