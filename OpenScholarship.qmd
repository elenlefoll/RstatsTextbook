...
1.  the original author and source is mentioned (as indicated by [`BY`](https://creativecommons.org/licenses/by-nc-sa/4.0/)),

2.  any derived version is not made into a commercial product ([`NC`](https://creativecommons.org/licenses/by-nc-sa/4.0/) stands for n*on-commercial*), and that
