...
> wrong = "No, this software is not open source.")
> ```
>
>  
>
...
> check_question("Python", options = c("MATLAB", "Flash", "Python"), type = "radio",
> button_label = "Check answer", q_id = 3,
> right = "Correct!",
> wrong = "No, this is one of the few genuinely closed-source programming languages.")
> ```
>
>  
>
...
The web-based version of this textbook is published as an Open Educational Resource (OER) under the Creative Commons license: [CC BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/). This means that it is free to read and use, as well as edit and transform, provided that a) the original author and source is mentioned, b) any derived version is not made into a commercial product, and c) that any derived versions of this textbook (e.g., a translated version or a version adapted for historians) are also shared with this same license.
...
To find out more about open source software in the context of research, I recommend reading:

-   <https://the-turing-way.netlify.app/reproducible-research/open/open-source>
:::
