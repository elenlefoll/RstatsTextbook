...
![Building a data masterpiece with {ggplot2} (artwork by [Allison Horst](https://twitter.com/allison_horst) CC BY 4.0)](images/AHorst_ggplot2.png){#fig-DataArtists fig-alt="A fuzzy monster in a beret and scarf, critiquing their own column graph on a canvas in front of them while other assistant monsters (also in berets) carry over boxes full of elements that can be used to customize a graph (like themes and geometric shapes). In the background is a wall with framed data visualizations. Stylized text reads: ggplot2: build a data masterpiece."}
...
Check that your data are correctly imported by examining the output of `View(Dabrowska.data)` and `str(Dabrowska.data)`. Once you are satisfied that that's the case, we ready to get creative! `r emoji("art")`
...
If you have a small screen, you can also click on the "`r emoji("magnifying-glass-tilted-right")` Zoom" button at the top of the Plots pane to view your plot in a separate *RStudio* window, which you can resize according to your needs.
:::
...
```{r}
#| fig-height: 3
#| fig-cap: "Default {scales} discreet palette under different forms of colour blindness and grey-scale."
#| fig-alt: "A graphic of multiple coloured boxes, the top row corresponding to the default {scales} discreet palette. The following rows simulate how these colours are perceived by someone with deuteranope and protanope colour blindness, and in grey-scale, respectively."
...
```{r}
#| fig-height: 3
#| fig-cap: "The colours we selected in @fig-PurpleBarplot under different forms of colour blindness and grey-scale."
#| fig-alt: "A similar graphic to the one above, but this time with the two shades of purple selected earlier."
...
```{r}
#| fig-height: 3
#| fig-cap: "Colours from the {{viridis}} package palette under different forms of colour blindness and grey-scale."
#| fig-alt: "A similar graphic to the one above, but this time with colours from the viridis package palette."
...
#| fig-cap: "@fig-ColourStackedBarplot in grey-scale."
...
#| fig-cap: "@fig-ColourStackedBarplot in the default {{viridis}} palette."
...
#| fig-cap: "@fig-ColourStackedBarplot in the \"turbo\" {{viridis}} palette."
...
#| fig-cap: "@fig-BarOccupGroup in the \"beyonce:X11\" palette."
...
#| fig-cap: "@fig-BarOccupGroup in the default \"BridgetRiley\" palette."
...
#| fig-cap: "@fig-BarOccupGroup in the \"janelle\" palette."
...
#| fig-cap: "@fig-BarOccupGroup in the \"FridaKahlo\" palette."
...
#| fig-cap: "@fig-BarOccupGroup in the \"kiss\" palette."
...
#| fig-cap: "@fig-BarOccupGroup in the \"speakNow\" palette."
...
#| fig-height: 4
#| fig-cap: "@fig-BarOccupGroup in the \"black and white\" theme."
#| fig-alt: "The barplot from Figure 10.5 displayed in black and white."
...
#| source-line-numbers: "6"
#| fig-height: 4
#| fig-cap: "@fig-BarOccupGroup in the \"dark\" theme."
#| fig-alt: "The barplot from Figure 10.5 printed in dark colours."
...
#| source-line-numbers: "6"
#| fig-height: 4
#| fig-cap: "@fig-BarOccupGroup in the \"light\" theme."
#| fig-alt: "The barplot from Figure 10.5 in the 'light' theme."
...
#| source-line-numbers: "6"
#| fig-height: 4
#| fig-cap: "@fig-BarOccupGroup in the \"minimal\" theme."
#| fig-alt: "The barplot from Figure 10.5 in the 'minimal' theme."
...
#| source-line-numbers: "6"
#| fig-height: 4
#| fig-cap: "@fig-BarOccupGroup in the \"void\" theme."
#| fig-alt: "The barplot from Figure 10.5 in the 'void' theme."
...
Pretty much all aspects of plot themes can be customised. To demonstrate this, @fig-SillyTheme displays a bar plot with some highly customised aesthetics. I will let you judge how meaningful these custom choices are and whether they genuinely help the reader to interpret the data... `r emoji("face-with-raised-eyebrow")`
...
#| fig-cap: "A heavily 'customised' bar plot."
#| fig-alt: "A bar plot showing the number of participants by occupational group. The plot features unconventional styling including a peach background, bright yellow grid lines, vertical axis labels, and bold colored text."
...
For example, if we want to display the full names of the four occupational groups used in @DabrowskaExperienceAptitudeIndividual2019, we can change the labels of the categories using `mutate()` and `fct_recode()` *before* piping the data into `ggplot()` (see @sec-ggplotData) and then flip the *x* and *y* axes using the coordinate layer `coord_flip()`. As shown in @fig-FlippedBarplot, this makes long labels much easier to read.
...
#| fig-alt: "A horizontal bar plot showing the number of participants by occupational group and gender. The chart shows four occupational categories on the y-axis with their full names: Professional-level job/student, Manual profession, Professionally inactive, and Clerical profession."
...
#| fig-alt: "This is a pie chart of the data above. A legend on the right identifies each occupational group with its corresponding color."
...
#| fig-cap: "Horizontal bar chart quantifying study participants by native language family."
#| fig-alt: "A horizontal bar plot titled showing the distribution of native languages among second language learners, with bars colored by language family."
...
#| fig-cap: "Bar plot of participant ages in @DabrowskaExperienceAptitudeIndividual2019."
#| fig-alt: "Bar plot of participant ages in the Dabrowska study."
ggplot(data = Dabrowska.data,
       mapping = aes(Age)) +
  geom_bar() +
  scale_x_continuous() +
...
#| fig-alt: "Histogram of participant ages in the Dabrowska study. The gaps between the bars have disappeared."
...
#| source-line-numbers: "3"
#| fig-height: 4
#| fig-cap: "Histogram of participant ages in @DabrowskaExperienceAptitudeIndividual2019 with default \"binwidth\" value."
#| fig-alt: "A histogram of participant ages in the Dabrowska study with default 'binwidth' value. There is no change from the previous chart."
...
#| source-line-numbers: "3"
#| fig-height: 4
#| fig-cap: "Histogram of participant ages in @DabrowskaExperienceAptitudeIndividual2019 with a \"binwidth\" value of 2."
#| fig-alt: "A histogram of participant ages in the Dabrowska study with the 'binwidth' value set to 2. The number of bars has been reduced as they are merged into fewer bins."
...
#| source-line-numbers: "3"
#| fig-height: 4
#| fig-cap: "Histogram of participant ages in @DabrowskaExperienceAptitudeIndividual2019 with a \"binwidth\" value of 4."
#| fig-alt: "A histogram of participant ages in the Dabrowska study with the 'binwidth' value set to 4. The number of bars has been reduced even further."
...
#| fig-cap: "Overlapping histogram of age data for L1 and L2 speakers from @DabrowskaExperienceAptitudeIndividual2019."
#| fig-alt: "An overlapping histogram of participant ages in the Dabrowska study, with the data for L2 speakers in yellow superimposed on the data for L1 speakers in purple, creating a different colour where they overlap."
...
@fig-SillyDensityPlot is an example of a density plot with some highly customised aesthetics. It goes without saying that, just because you *can* customise many aspects of a `geom_` layer, it doesn't necessarily mean that it's a good idea to do so! `r emoji("upside-down-face")`

```{r}
#| label: "fig-SillyDensityPlot"
#| code-fold: true
#| code-summary: "Show code to generate plot below."
#| fig-cap: "Density plot of L2 participants' non-verbal IQ scores."
...
#| code-fold: true
#| code-summary: "Show code to generate plot below."
#| fig-cap: "Overlapping density plot of L1 and L2 participants' non-verbal IQ scores."
...
#| fig-cap: "Box plot of participants' English grammar test results."
#| fig-alt: "A vertical box plot of participants' English grammar test results. The minimum is placed slightly below 50 with an interquartile range from 75 to 95 and a median at 90. There are several outliers from 0 to the minimum."
...
::::::::::::::: {.callout-note collapse="false"}
#### Going further: Dot plots and violin plots `r emoji("violin")`
...
#| echo: false
#| fig-asp: 1.2
#| fig-cap: Dot plots of participants' English collocation test results."
...
#| echo: false
#| fig-asp: 1.2
#| fig-cap: Violin plots of participants' English collocation test results."
...
#| echo: false
#| fig-asp: 1.2
#| fig-cap: "Violin-boxplot of participants' English collocation test results."
#| fig-alt: "The previous violin plots have been overlaid with box plots."
...
#| fig-alt: "The previous scatter plots with a blue lines indicating the correlation between the two variables. For L1 speakers the line proceeds through the cluster upwards and to the right at a shallow angle. For L2 speakers a similar line trajectory cuts through the bottom of the top cluster. For both groups there is a weak positive correlation."
...
-   If the regression line goes up, there is a **positive correlation** between the two numeric variables. `r emoji("arrow_upper_right")`
-   If the line goes down, there is a **negative correlation**. `r emoji("arrow_lower_right")`
-   The steeper the line, the stronger the correlation. `r emoji("muscle")`
-   If the line is flat (or nearly flat), there is no (linear) correlation between the two variables. `r emoji("arrow_right")`
-   Be aware that even very strong correlations do not necessarily imply (direct) causation. `r emoji("x")`
...
```{r}
#| fig-cap: "Word cloud of native languages from the study."
#| fig-alt: "A word cloud of participants' native languages coloured according to language family and sized according to the number of participant speakers."
...
#| fig-cap: "Scatter plot of L2 participants' grammar comprehension scores and age coloured by native language."
#| fig-alt: "A scatter plot comparing L2 participants' grammar comprehension scores and age, with the dots coloured according to their native language."
...
#| fig-cap: "Scatter plot of L2 participants' grammar comprehension scores and age with the dots replaced by text."
...
#| fig-cap: "Scatter plot of female L2 participants' grammar comprehension scores and age who scored lower than 90."
...
#| fig-cap: "Scatter plot of female L2 participants' grammar comprehension scores and age who scored lower than 90, expanded with {{ggrepel}}."
...
#| fig-cap: "Boxplot of participants' grammar comprehension test scores overlaid by dots."
...
#| fig-cap: "The boxplots with dots slightly randomized by {{geom_jitter}}."
#| fig-alt: "The previous boxplots with the dots slightly randomized using geom_jitter."
...
#| fig-cap: "The boxplots with dots coloured according to participants gender."
#| fig-alt: "The previous boxplots with the dots coloured according to participant gender."
...
#| fig-cap: "The boxplots combining shapes to indicate gender and colour to indicate occupation."
#| fig-alt: "The previous boxplots with the dots as circles or squares to indicate participant gender and coloured according to participant occupation."
...
#| fig-cap: "Boxplots with interactive data points."
...
You are now ready to get creative: Complete this chapter's [tasks and quizzes](https://elenlefoll.github.io/RstatsTextbook/11_quiz.html)! `r emoji("art")`
:::
