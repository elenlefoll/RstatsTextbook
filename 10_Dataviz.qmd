...
Our starting point for this chapter is the wrangled combined dataset that we created and saved in @sec-DataWrangling. Follow the instructions in this chapter to create this `R` object or download `combined_L1_L2_data.rds` from [the textbook's GitHub repository](https://github.com/elenlefoll/RstatsTextbook/blob/main/data/processed/combined_L1_L2_data.rds){.uri}.
:::
...
-   To check assumptions of statistical tests or models (see @sec-InfeRentialStats and @sec-LineaRregression)
...
Well done! You have successfully completed this chapter on data visualisation using the Grammar of Graphics approach. You answered [`r checkdown::insert_score()` out of 9 questions]{style="color:green;"} correctly.

Are you confident that you can...?

-   [ ] Use the syntax of graphics (data, aesthetics, geometries, facet, scales, coordinates, and theme layers) to create and customise your graphs
-   [ ] Create and interpret bar plots, histograms, density plots, violin plots, boxplots, scatter plots and facetted plots
-   [ ] Creat and interpret word clouds, complex plots, and interactive plots
