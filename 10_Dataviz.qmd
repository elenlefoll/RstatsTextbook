...
Choosing an appropriate palette is not the only way to make your visualisations accessible to colour-blind readers. Another way is to provide redundant mappings to other aesthetics such as size, line type, shape, or pattern (see @fig-PatternBarplot).
...
![Illustration of some of the customisation options of `ggplot` objects](images/SillyTheme.png)
:::
...
```{r}
#| code-fold: true
#| code-summary: "Show code to answer Q10.5"
#| eval: false
