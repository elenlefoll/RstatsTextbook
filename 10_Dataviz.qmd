...
```{r}
#| code-fold: true
#| code-summary: "What to do if you get the error message: seq.default(from, to, by) : invalid"
...
[**Q10.18**]{style="color:green;"} Having removed the outlier point from the scatter plot, now add a regression line to visualise the correlation between the two variables. Which of the following options best fits the gap in the sentence below?

> In this group of L2 speakers, there is █ █ █ █ █ █ █ █ █ █ correlation between participants' grammar test scores and their length of residence in the UK.
