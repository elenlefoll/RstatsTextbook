...
-   [ ] Use projects in RStudio (@sec-RProject)
-   [ ] Import data from .csv files (@sec-ImportingDataCSV)
-   [ ] Check weather your data is correctly imported (@sec-ImportingErrors)
...
-   [ ] Import data files from SPSS, SAS and Stata (@sec-SPPS)
-   [ ] Import other file formats (@sec-OtherFileFormats)
