...
-   Importing data from LibreOffice/OpenOffice Calc, Microsoft Excel, Google Sheets, SPSS and other formats
...
random_answer_order = TRUE,
q_id = "Q6.13", 
right = "That's right! There are `R` packages that allow us to easily import all of these types of data files (and many more!) into `R`.",
