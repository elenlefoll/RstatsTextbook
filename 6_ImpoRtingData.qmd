...
-   Importing data from LibreOffice Calc, Microsoft Excel, Google Sheets, SPSS and other formats
-   Examining a data frame object in `R`

In future chapters, we will continue to work with these data. We will learn how to "clean them up" for data analysis, before we begin to explore them using descriptive statistics and data visualisations.
