...
Now it's time to start exploring research data in `R`! In [the next chapter](https://elenlefoll.github.io/RstatsTextbook/7_VariablesFunctions.html), you will learn how to work with in-built `R` functions to find out more about the DSV data from @DabrowskaExperienceAptitudeIndividual2019 that you imported in this chapter.
