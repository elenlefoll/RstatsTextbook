...
#| fig-alt: "The bar plot from @fig-BarOccupGroup displayed horizontally."
...
#| fig-alt: "The pie chart from @fig-OccupGroupPieChart, with an abbreviated legend header"
...
#| fig-width: 4
#| fig-height: 2
#| fig-alt: "The pie chart from @fig-OccupGroupPieChart, with the legend abbreviated."
...
#| fig-alt: "The pie chart from @fig-OccupGroupPieChart, unabbreviated."
...
#| echo: false
#| fig-height: 4
#| fig-alt: "A histogram displaying participants' scores on the English grammar test. There is a small group centered around 10, but most participants scored between 75 and 100, the largest group scoring 95."
...
#| echo: false
#| fig-height: 4
#| fig-alt: "The previous histogram with the test results of L2 speakers superimposed on the test scores of native speakers. The group of participants who scored between 75 and 100 is the largest in both groups, but fewer L1 speakers scored below this range."
...
#| echo: false
#| fig-height: 4
#| fig-alt: "The previous histogram has been divided into two individual charts for L1 and L2 speakers."
...
#| fig-alt: "The previous density plot has been divided into two individual plots for L1 and L2 speakers. Whereas the L1 speakers form a steep mountain centered on 95 with a small plateau from 75 to 80, the L2 speakers form a small hill around 20 and a larger one around 95."
