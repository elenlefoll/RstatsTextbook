...
# A few parting words on AI {#sec-AI}

**Alternative title: Resea`R`ching with AI?**

If you are reading the last chapter of what is by no means a short textbook, you are likely someone who is eager to acquire new skills and knowledge. As such, you are well aware that learning is a process that requires intrinsic motivation, time, and a great deal of effort and patience. Many tech companies, by contrast, are keen for us to believe that this tiring, time-consuming experience of human learning is no longer necessary: So-called 'artificial intelligence' (AI) systems are designed to spare us the burden of thinking for ourselves. In this context, it is therefore legitimate to ask: Is is still worth devoting so much time and effort to acquire and further develop knowledge and skills in data analysis, programming, and statistics, if the answers to our (research) questions are just a few, effortless prompts away?

This concluding chapter explains why we can answer this question with a decisive "no". To this end, we consider the role of AI in research and learning before recapping what we have learnt so far and where to go from there.

## On the technology behind "AI" 🤖

Contrary to popular belief, 'artificial intelligence' is not a technology. It is, and always has been, a marketing term used to sell (or get research funding for) a wide, diverse, and shifting array of ideas, research projects, systems, and technologies [see e.g. @guestUncriticalAdoptionAI2025 and @vanrooijReclaimingAITheoretical2024]. Despite marketing claims, these systems and technologies are not 'intelligent'; they cannot think, understand, or reason [see e.g. @benderAIConHow2025; @quattrociocchiEpistemologicalFaultLines2025]. This is why I put quotation marks around the terms "artificial intelligence" and "AI" when they are used to refer to technologies, systems, and products.
...
<br>
",
wrong = "Not quite. You will need to select all the relevant analogies to get this question right. For a tip, check the hint below.
<br>
<br>")
...
check_question("The Matthew effect describes how successful researchers receive more recognition and opportunities, leading to more success.",
               options = c("The Matthew effect describes how successful researchers receive more recognition and opportunities, leading to more success.",
...
check_hint("Jeff Pooley discusses how LLMs can re-inscribe existing biases in academia.", hint_title = "🐭 Click on the mouse for a hint.")
...
Read through Google's "AI overview" displayed in @fig-AIcheese.
...
![Difference in means of overall task time and test scores between the treatment (AI Assistant) and control (No AI) groups (n = 52). Error bars represent 95% CI. Significance values correspond to treatment effect. [Source: @tamkin2026: Fig. 1]](images/Shen_Tamkin2026_Fig1.png){#fig-ShenTamkin fig-alt="Two plots: the first shows the average time taken to complete the experimental task. The average with AI was 23 minutes, and without AI nearly 25. But the confidence intervals overlap considerably. The second plot shows average test scores. Here the difference is much clearer: the AI group scores 50% on average, whilst the non-AI control group scores around 65%." width="454"}
...
In @sec-ttest, we conducted the following *t*-test to find out whether the difference between the average L1 and L2 non-verbal IQ 'Blocks' test scores was significant or not:
...
The output of the `t.test()` function above was fed into a LLM (DeepSeek R1 Distill Llama 70B) with a prompt requesting a short paragraph interpreting these results. The model's response is printed below:
...
check_question("The confidence interval is incorrectly interpreted as a probability statement about the true mean difference.",
               options = c("The LLM fails to recognise that the t-test was not appropriate because the data are not normally distributed.",
               ...
               random_answer_order = TRUE,
               type = "radio",
               right = "That's right! The 95% confidence interval does not mean that there's a 95% probability that the true difference lies in that range. Rather, it means that, if we repeated the study many times, 95% of such intervals would contain the true difference.",
               wrong = "No, that's not it. Consider what the confidence interval actually means. This is explained in the Stack Exchange post examined as part of the quiz questions above.")
```
:::
::::
...
-   Bender, Emily M. & Alex Hanna. 2025. *The AI Con: How to Fight Big Tech’s Hype and Create the Future We Want*. HarperCollins.
...
-   Mühloff, Rainer. 2025. Introduction to the Ethics of AI 2025. Lecture video recordings. <https://rainermuehlhoff.de/en/EoAI2025/>. \[Open Educational Resource\].
:::
...
Happy lea`R`ning - enjoy the journey! 🚀

![Artwork by [Allison Horst](https://allisonhorst.com/r-packages-functions) ([CC BY 4.0](https://creativecommons.org/licenses/by/4.0/))](images/AHorst_RFlowers.png){#fig-RFlowers fig-alt="Two cute little monsters decorating the R logo with hearts and flowers" width="442"}

::: {.content-visible when-format="docx"}
# Ideas {.unnumbered}

@westModernDayOraclesBullshit

Cite: <https://r4ds.hadley.nz/workflow-help.html>

<https://www.vice.com/en/article/chatgpt-is-a-bullshit-generator-waging-class-war/?>

-   Reading documentation: <https://www.neilwright.uk/posts/how-to-read-r-package-documentation>

-   Dangers of using AI for coding: <https://www.louisbouchard.ai/genai-coding-risks/>

-   Life long learning: <https://bookdown.org/rwnahhas/IntroToR/lifelong.html>
...
-   --\> <https://www.seascapemodels.org/rstats/2025/06/08/vibe-coding-not-for-scientists.html>
...
Well done! You have answered [`r checkdown::insert_score()` out of 12 questions]{style="color:green;"} correctly.
