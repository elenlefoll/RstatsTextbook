...
Once you are satisfied that the data has been correctly imported and that you are familiar with the dataset, you are ready to tap into the potential of multiple linear regression modelling! 🚀
:::
...
Then, install the {remotes} package, which allows you to install older versions of packages (if they are compatible with your `R` version). You will get a message notifying you that it is necessary to restart your `R` session. Click "yes".
