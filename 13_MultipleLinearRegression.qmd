...
-   The observations (i.e. the data points) used to fit a **fixed-effect model** must be independent of each other. In the language sciences, such a situation is actually quite rare (see @sec-IndependenceSLR). To model interdependencies between observations, we can fit **mixed-effects models** (also called multilevel or hierarchical models) [to learn more, see e.g. @griesStatisticsLinguisticsPractical2021: Chapter 6; @sondereggerRegressionModelingLinguistic2023: Chapters 8-10; @winterStatisticsLinguistsIntroduction2020: Chapters 14-15].
