...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/OpenMaterials.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/OpenData.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/OpenCode.png}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{images/OpenAccess.jpg}
...
\includegraphics[width=1.04167in,height=\textheight,keepaspectratio,alt={LibreOffice logo}]{images/LibreOffice_logo.png}
::: ::::

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Installing LibreOffice}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

To complete the tasks of this textbook, you will need to
\textbf{download} and \textbf{install} the open-source software suite
\textbf{LibreOffice}. This is important as we will use its spreadsheet
editor, \textbf{LibreOffice Calc}, in the following two chapters.
...
\item
  ...
  \tightlist
  \item
    the latest version for ``technology enthusiast, early adopter or
    power user''
  \item
    or the ``slightly older'' but more tested version.
  \end{itemize}
\item
  In drafting this textbook, I used the latest version which, at the
  time, was version 24.2.2. The one that you download will be higher
  than that as the developers regularly publish updates. If you already
...
\item
  Detailed documentation is available in many different languages:
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Screenshot of the default setting for the file type \textquotesingle.csv\textquotesingle{}}]{images/DefaultAppsExcel.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Screenshot of the selection dialogue for default apps.}]{images/DefaultAppsChangeDialog.png}}
...
\caption{\label{fig-Kitchens}The kitchen workflow metaphor (artwork CC
BY 4.0 \href{https://twitter.com/allison_horst}{@allison\_horst}).}
...
\protect\phantomsection\label{annotated-cell-339}%
\begin{Shaded}
\begin{Highlighting}[]
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,alt={New Project Wizard for Create Project from Existing Directory R~Project. It shows the working directory: .../Documents/DataLiteracyTextbook/Dabrowska2019. There are three buttons: Browse..., Create Project and Cancel}]{images/RStudioNewProjectDialogue.png}
...
Section~\ref{sec-OpenSource}) and OpenOffice Calc, you can install the
\{readODS\} package and use its \texttt{read\_ods()} function to import
\texttt{.ods} files. Details about all the options can be found here
...
\NormalTok{MySheetsData }\OtherTok{\textless{}{-}} \FunctionTok{read\_sheet}\NormalTok{(}\StringTok{"https://docs.google.com/spreadsheets/YourURL"}\NormalTok{,}
                            \AttributeTok{sheet =} \DecValTok{1}\NormalTok{,}
                            \AttributeTok{col\_names =} \ConstantTok{TRUE}\NormalTok{,}
...
\NormalTok{MySheetsData }\OtherTok{\textless{}{-}} \FunctionTok{read\_sheet}\NormalTok{(}\StringTok{"YourGoogleSheetsID"}\NormalTok{,}
                            \AttributeTok{sheet =} \DecValTok{1}\NormalTok{,}
                            \AttributeTok{col\_names =} \ConstantTok{TRUE}\NormalTok{,}
                            \AttributeTok{na =} \StringTok{"NA"}\NormalTok{)}
\end{Highlighting}
...
\includegraphics[width=4.39583in,height=\textheight,keepaspectratio,alt={Screenshot of the Console pane of *RStudio* showing the above command having been run and having returned an error message: Error in file(file, "rt") : cannot open the connection In addition: Warning message: In file(file, "rt") :   cannot open file \textquotesingle/Users/lefoll/Documents/Uni Work/RstatsTextbook/Dabrowska2019/data/L1\_data.csv\textquotesingle: No such file or directory}]{images/ImportErrorSpace.png}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Screenshot of the Files pane in *RStudio* displaying the options after clicking on a CSV file. The option \textquotesingle Import Dataset...\textquotesingle{} is highlighted. Clicking on this will open the \textquotesingle Import Text Data\textquotesingle{} dialog for importing this file.}]{images/RStudioImportDataset.png}}
...
DSV data from Dąbrowska (2019) that you imported in this chapter.
...
successfully imported the two datasets from Dąbrowska (2019) into your
...
\pandocbounded{\includegraphics[keepaspectratio,alt={The environment pane contains two rows under the label Data: the L1.data object with 90 obs. of 31 variables and the L2.data object with 67 obs. of 45 variables}]{images/RStudioEnvironment.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={RStudio tab showing the first 22 rows and 7 columns of the L1.dataset. The filter and search buttons at the top of the tab are circled in red.}]{images/ViewL1data.png}}
...
\protect\phantomsection\label{annotated-cell-71}%
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{annotated-cell-376}%
\begin{Shaded}
\begin{Highlighting}[]
...
questions from this chapter if you have created an RProject and
successfully imported the two datasets from Dąbrowska (2019) into your
local \texttt{R} environment (see Figure~\ref{fig-DataLoaded}). See
detailed instructions Section~\ref{sec-RProject} --
Section~\ref{sec-ImportingDataCSV}.
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Three boxplots of the ages of different groups. All three are symmetrical and have their medians at 35 years. Group one's box extends from 32.5 to 37.5 years, group two's box extends from 32.6 to 37.4 years and group three's box extends from 33 to 37 years. The maximums and minimums are at 46 and 24; 44 and 26; and 42.5 and 28 years respectively.}]{8_DescriptiveStats_files/figure-pdf/fig-NormalBoxplots-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Further reading}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
by Fahd Alhazmi (2020), who provides a beautiful visual guide to
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={Screenshot of R Console showing the output of the command library(tidyverse). The output lists all attached core tidyverse packages and their versions and then it lists "Conflicts: tidyverse\_conflicts() ── ✖ dplyr::filter() masks stats::filter() ✖ dplyr::lag()    masks stats::lag() ℹ Use the conflicted package to force all conflicts to become errors"}]{images/TidyverseConflicts.png}
...
\begin{center}
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{images/help_word.png}
\end{center}
...
\protect\phantomsection\label{annotated-cell-139}%
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{L2.data}\SpecialCharTok{$}\NormalTok{NativeLg }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{str\_to\_title}\NormalTok{() }\SpecialCharTok{|\textgreater{}} 
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Going further: Using regular expressions (regex) \emoji{rocket}}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\protect\phantomsection\label{annotated-cell-440}%
\begin{Shaded}
\begin{Highlighting}[]
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Extract from dplyr cheatsheet showing all the "join" functions. Screenreader friendly version can be found here: https://rstudio.github.io/cheatsheets/html/data-transformation.html}]{images/dplyr_cheatsheet_extract.png}}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={A similar graphic to the one above, but this time with colours from the viridis package, which can be distinguished by most colour-blind people.}]{10_Dataviz_files/figure-pdf/fig-colourBlindnessViridis-1.pdf}
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={The barplot from Figure 10.5 labels in a different font, bars filled with different shades of blue and grey, a light blue background, white lines, and a legend at the top of the graph as opposed to one the right.}]{10_Dataviz_files/figure-pdf/fig-Economist-1.pdf}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Barplot tallying participants\textquotesingle{} ages in the Dabrowska study. There is one bar per age.}]{10_Dataviz_files/figure-pdf/fig-AgeBarPlot-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Histogram of participant ages in the Dabrowska study. Compared to the barplot, the gaps between the bars have disappeared.}]{10_Dataviz_files/figure-pdf/fig-AgeHistogram-1.pdf}}
...
\protect\phantomsection\label{annotated-cell-466}%
\begin{Shaded}
\begin{Highlighting}[]
...
\pandocbounded{\includegraphics[keepaspectratio,alt={A vertical boxplot of participants\textquotesingle{} English grammar test results. The minimum is placed slightly below 50 with an interquartile range from 75 to 95 and a median at 90. There are several outliers from 0 to the minimum.}]{10_Dataviz_files/figure-pdf/fig-GrammarBoxPlot-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{How to report}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={Cartoon of a normal distribution looking skeptically at an excited looking bimodal and negatively skewed distribution. The first says to the second, "you\textquotesingle re not normal."}]{images/AHorst_NotNormal.png}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={Scatter plot of learners\textquotesingle{} test results expressed as the number of correct answers they got on the x-axis and as the percentage of correctly answered questions on the y-axis. The data points form a perfect linear relationship. A straight blue regression line runs through all the data points.}]{12_Modelling_files/figure-pdf/fig-RTScatterPLot-1.pdf}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={This is the same plot as above. The only difference is that a dotted blue line extends the fit blue line to zero.}]{12_Modelling_files/figure-pdf/fig-RTScatterPLotIntercept-1.pdf}
...
\item
  ...
  \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={A linear line chart with years as the x-axis and two variables on the y-axis. The first variable is air pollution in Johnstown, Pennsylvania and the second variable is Master\textquotesingle s degrees awarded in education. The chart goes from 2012 to 2021, and the trends in the two variables match closely over that time. The following statistics are displayed on the graph: Pearson\textquotesingle s r = 0.989, R-squared = 0.979, p \textless{} 0.01. The source is also labelled: tylervigen.com/spurious/correlation/3139}]{images/Vigen_unhealthy-air-quality-in-johnstown-pennsylvania_correlates-with_masters-degrees-awarded-in-education.png}
...
\protect\phantomsection\label{annotated-cell-250}%
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{annotated-cell-541}%
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{annotated-cell-278}%
\begin{Shaded}
\begin{Highlighting}[]
...
\protect\phantomsection\label{annotated-cell-279}%
\begin{Shaded}
\begin{Highlighting}[]
\FloatTok{51.9162} \SpecialCharTok{+} \hspace*{\fill}\NormalTok{\circled{1}}
\FloatTok{1.3088} \SpecialCharTok{*} \DecValTok{31} \SpecialCharTok{+} \hspace*{\fill}\NormalTok{\circled{2}}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Reporting a multiple regression model}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio,alt={Another scatterplot indicating the linearity of the relationship between fitted values and the square root of absolute standardised residuals. Most of the dots fall between 0.3 and 1.3 standardised residuals. The linearity line begins relatively level at around 0.9 standard residuals and dips to around 0.6 between fitted values 70 and 80.}]{13_Regression_files/figure-pdf/fig-Homoscedasticity-1.pdf}
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio,alt={A scatterplot relating standard normal distribution quantities and sample quantile deviations. Most of the dots are clustered around the line at 0 sample quantile deviations from standard normal distribution quantities -1 to 2, outside of which they are more scattered. All of the dots are encapsulated by a shaded area which thins at the middle.}]{13_Regression_files/figure-pdf/fig-Normality-1.pdf}
...
A standalone version of this chapter is available as an
\href{https://elenlefoll.quarto.pub/quarto4research/}{interactive
webpage} and in a downloadable
\href{https://elenlefoll.quarto.pub/quarto4research/Quarto4Research.pdf}{PDF}
version. It is entitled \emph{Quarto for reproducible research workflows
and academic publishing: A step-by-step tutorial} (Le Foll 2026) and,
unlike the present chapter which assumes that you have read prior
chapters, has no prerequisites.
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{In brief}, titlerule=0mm, toprule=.15mm, toptitle=1mm]
...
\pandocbounded{\includegraphics[keepaspectratio,alt={A screenshot of the citations window in RStudio. "dabrowska" has been entered in the search bar, and the 2019 study has been selected, generating a citation below.}]{images/Quarto_citation.png}}
