...
\pandocbounded{\includegraphics[keepaspectratio,alt={Header text saying \textquotesingle R learners\textquotesingle{} above five friendly-looking monsters holding up signs that together read ``we believe in you.''}]{images/AHorst_RLearnersWeBelieve.png}}
...
\emoji{purple-heart}}{Acknowledgements }}\label{acknowledgements}
\addcontentsline{toc}{section}{Acknowledgements \emoji{purple-heart}}

\markright{Acknowledgements \emoji{purple-heart}}
...
\includegraphics[width=3.44792in,height=\textheight,keepaspectratio]{images/LibreOffice_logo.png}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={Heading of PDF version of the article from the journal Language Learning: A Journal of Research in Language Studies. EMPIRICAL STUDY First Language Influence on SecondLanguage Offline and Online AmbiguousPronoun Resolution Sarah Schimke, Israel de la Fuente, Barbara Hemforth, and Saveria Colonnada from University Münster, University of Lille/CNRS, CNRS/University of Paris Diderot, and University of Paris 8/CNRS}]{images/SchimkeEA2018Abstract.png}
...
\includegraphics[width=0.2\linewidth,height=\textheight,keepaspectratio,alt={The Open Data badge is blue and shows a simple barplot and the Open Materials is yellow and shows an open cardbox.}]{images/OpenDataOpenMaterials.jpg}
...
\caption{\label{fig-Playmobil}Cropped image from Experiment 1 in Schimke
et al. (2018) CC BY-NC-SA \url{https://doi.org/10.48316/YD90P-94kUi}}
...
\texttt{Ctrl-O} (windows), \texttt{Ctrl-O} (linux), \texttt{Cmd-O} (mac)
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={A screenshot showing a CSV file opened in LibreOffice Calc. It is formatted as a table.}]{images/DSVinCalc.png}
...
seriously `spice things up'\ldots{} but not in a good way!
\emoji{hot-pepper}️ Whether you are working on a short course assignment,
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={A frustrated looking little monster in front of a very disorganised cooking area, with smoke and fire coming from a pot surrounded by a mess of bowls, utensils, and scattered ingredients.}]{images/AHorst_MessyKitchen.png}

}

\caption{\label{fig-MessyKitchen}An inefficient and potentially
dangerous workflow (\href{https://twitter.com/allison_horst}{artwork CC
BY 4.0 @allison\_horst})}
...
\includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={An organised kitchen with sections labeled "tools", "report" and "files", while a monster in a chef\textquotesingle s hat stirs in a bowl labeled "code."}]{images/AHorst_TidyKitchen.png}

}

\caption{\label{fig-TidyKitchen}A tidy and efficient workflow
...
the part of the filename in Thai as this could also lead to
misunderstandings.
...
extension and should ideally not be used elsewhere in the filename.
...
\texttt{Ctrl-V} (windows), \texttt{Ctrl-V} (linux), \texttt{Cmd-V} (mac)
...
\section{\texorpdfstring{Backing up data: `Fire safety' measures in the
digital kitchen
\emoji{fire-extinguisher}️}{Backing up data: `Fire safety' measures in the digital kitchen ️}}\label{sec-BackupData}
...
\caption{\label{fig-Kitchens}The kitchen workflow metaphor
(\href{https://twitter.com/allison_horst}{artwork CC BY 4.0
@allison\_horst}).}
...
\includegraphics[width=3.91667in,height=\textheight,keepaspectratio,alt={Photo of a gardener\textquotesingle s tomato harvest, showing tomatoes are various sizes and colours.}]{images/TomatoHarvest.jpg}
...
\{janeaustenr\} package ``depends'' on a \texttt{R} version that is 3.5
...
\pandocbounded{\includegraphics[keepaspectratio,alt={janeaustenr: Jane Austen\textquotesingle s Complete Novels Full texts for Jane Austen\textquotesingle s 6 completed novels, ready for text analysis. These novels are "Sense and Sensibility" ", "Pride and Prejudice" \textquotesingle, "Mansfield Park" , "Emma". \textquotesingle, "Northanger Abbey", and "Persuasion". Version: Depends: Suggests: Published: DOI: Author: Maintainer: BugReports: License: URL: NeedsCompilation: no Materials: CRAN checks: 1.0.0 R (≥ 3.5) dplyr, testthat 2022-08-26 10.32614/CRAN.package.janeaustenr Julia Silge I {[}aut, cre{]} Julia Silge \textless{} julia silge at gmail.com\textgreater{} https://github.com/juliasilge/janeaustenr/issues MIT + file LICENSE https://github.com/juliasilge/janeaustenr README, NEWS janeaustenr results}]{images/CRAN_janeaustenr.png}}

}

\caption{\label{fig-CRANJane}Screenshot from
\url{https://cran.r-project.org/web/packages/janeaustenr/index.html}
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={Finder window showing the RStudio.app icon and the folder Apps. A warning message reads: An older item named "RStudio.app" already exists in this location. Do you want to replace it with the newer one you\textquotesingle re copying? The clickable options are: Keep Both Stop Replace}]{images/UpdateRStudio.png}
...
\includegraphics[width=5.72917in,height=\textheight,keepaspectratio,alt={RStudio screenshot showing that an object is now stored in the session environment in the left-hand pane.}]{images/ObjectCreation.png}
...
\texttt{Tab} key. \emph{RStudio} will then give you a drop-down menu
with possible options. Select the one you want by clicking on it or
pressing ``Enter''.
...
\includegraphics[width=5.72917in,height=\textheight,keepaspectratio,alt={RStudio screenshot showing the environment pane with six stored objects.}]{images/MultipleObjectsEnvironmentPane.png}
...
\item
  ...
  \texttt{Ctrl-Shift-N} (windows), \texttt{Ctrl-Shift-N} (linux), \texttt{Cmd-Shift-N} (mac).
\end{enumerate}
...
\texttt{Ctrl-Enter} (windows), \texttt{Ctrl-Enter} (linux), \texttt{Cmd-Enter} (mac).
...
\item
  Use the keyboard shortcut
  \texttt{Ctrl-S} (windows), \texttt{Ctrl-S} (linux), \texttt{Cmd-S} (mac).
\end{enumerate}
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={RStudio screenshot showing the console with an incomplete function and a red ellipse around the +-symbol.}]{images/ConsoleUncompleteFunction.png}
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={RStudio screenshot showing the console with an error.}]{images/ConsoleError.png}
...
\texttt{Esc} (windows), \texttt{Esc} (linux), \texttt{Esc} (mac) on your
...
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={A frustrated little monster sits on the ground with his hat next to him, saying "I just need a minute." Looking on empathetically is the R logo, with the word "Error" in many different styles behind it.}]{images/AHorst_ErrorMonster.png}
...
can select `File', then `New Project\ldots{}' (see ``a'' on
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={New Project Wizard for Create Project from Existing Directory R Project. It shows the working directory: .../Documents/DataLiteracyTextbook/Dabrowska2019. There are three buttons: Browse..., Create Project and Cancel}]{images/RStudioNewProjectDialogue.png}
...
\includegraphics[width=4.58333in,height=\textheight,keepaspectratio,alt={Screenshot of the project folder in the MacOS Finder with the .Rproj-file highlighted. To launch the project in a new session, the corresponding .Rproj-file can be double-clicked.}]{images/ProjectFileFinder.png}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,alt={Screenshot of the Files pane of RStudio showing the contens of a folder entitled \textquotesingle Dabrowska2019\textquotesingle. It contains an RProject file called \textquotesingle Dabrowska2019.Rproj\textquotesingle, a folder called \textquotesingle analysis\textquotesingle{} and another folder called \textquotesingle data\textquotesingle.}]{images/WorkingDirectory.png}
...
\texttt{Ctrl-Shift-M} (windows), \texttt{Ctrl-Shift-M} (linux), \texttt{Cmd-Shift-M} (mac)
...
keyboard shortcut
\texttt{Ctrl-I} (windows), \texttt{Ctrl-I} (linux), \texttt{Cmd-I} (mac)
...
\item
  ...
  \texttt{Ctrl-Alt-I} (windows), \texttt{Ctrl-Alt-I} (linux), \texttt{Cmd-Option-I} (mac)
\item
...
\item
  ...
  \texttt{Shift-Ctrl-Enter} (windows), \texttt{Shift-Ctrl-Enter} (linux), \texttt{Shift-Cmd-Enter} (mac).
\end{itemize}
...
\texttt{Ctrl-Shift-F8} (windows), \texttt{Ctrl-Shift-F8} (linux), \texttt{Cmd-Shift-F8} (mac).This
