...
\texttt{Cmd-O} (mac), \texttt{Ctrl-O} (windows), \texttt{Ctrl-O} (linux)
...
\texttt{Cmd-V} (mac), \texttt{Ctrl-V} (windows), \texttt{Ctrl-V} (linux)
...
\item
  ...
  \texttt{Cmd-Shift-N} (mac), \texttt{Ctrl-Shift-N} (windows), \texttt{Ctrl-Shift-N} (linux).
\end{enumerate}
...
\texttt{Cmd-Enter} (mac), \texttt{Ctrl-Enter} (windows), \texttt{Ctrl-Enter} (linux).
...
\item
  Use the keyboard shortcut
  \texttt{Cmd-S} (mac), \texttt{Ctrl-S} (windows), \texttt{Ctrl-S} (linux).
\end{enumerate}
...
\texttt{Esc} (mac), \texttt{Esc} (windows), \texttt{Esc} (linux) on your
...
\texttt{Cmd-Shift-M} (mac), \texttt{Ctrl-Shift-M} (windows), \texttt{Ctrl-Shift-M} (linux)
...
keyboard shortcut
\texttt{Cmd-I} (mac), \texttt{Ctrl-I} (windows), \texttt{Ctrl-I} (linux)
...
\item
  ...
  \texttt{Cmd-Option-I} (mac), \texttt{Ctrl-Alt-I} (windows), \texttt{Ctrl-Alt-I} (linux)
\item
...
\item
  ...
  \texttt{Shift-Cmd-Enter} (mac), \texttt{Shift-Ctrl-Enter} (windows), \texttt{Shift-Ctrl-Enter} (linux).
\end{itemize}
...
\texttt{Cmd-Shift-F8} (mac), \texttt{Ctrl-Shift-F8} (windows), \texttt{Ctrl-Shift-F8} (linux).This
