---
title: "The g`R`ammaticalization of 'perdón' in Spanish varieties"
...
The Chi-Square test that there is a statistically significant association between Spanish variety and apology marker (χ² = 192.35, df = 3, *p* \< .001), matching the results in @Jansegers2024.
...
Our output confirms the study’s finding that *perdón* is strongly favored when the speaker’s own face is at stake. All percentages and frequencies match those in the original study exactly, without rounding differences. 
...
For more information on how to insert bibliographic references in Quarto documents, see @sec-Citations.
:::
