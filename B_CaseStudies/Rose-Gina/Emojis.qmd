...
```{r echo=FALSE}
here::i_am("B_CaseStudies/Rose-Gina/Emojis.qmd")
```
...
#| eval: false
#| echo: false
ggsave(plot = plot_concern_surprise, here("B_CaseStudies", "Rose-Gina", "images", "CS_RoseGina_plot_concern_surprise.png"), height = 1344, width = 1881, units = "px")
```
...
ggsave(plot = AUpatch_complete, 
       here("B_CaseStudies", "Rose-Gina", "images", "CS_RoseGina_AUpatch_complete.png"), 
