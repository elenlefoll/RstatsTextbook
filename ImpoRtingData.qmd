...
To create a new Project, you have two options. In RStudio, you can select 'File', then 'New Project...' (see "a" on @fig-RStudioProjectButton). Alternatively, you can click on the Project button in the top-right corner of your RStudio window and then select 'New Project...' (see "b" on @fig-RStudioProjectButton).

![Using the Project button in RStudio](images/RStudioProjectButton.png){#fig-RStudioProjectButton fig-alt="Screenshot of the dropdown menu under the 'Project: (None)' in RStudio, displaying options such as 'New Project...', 'Open Project...', 'Open Project in New Session...', and 'Close Project.' The 'New Project...' option is circled in red." width="440"}
...
In @sec-SavingData, you should have already saved the data that we want to import in a dedicated folder on your computer. Here, a folder is the same as a directory. Hence, you can select the second option: 'Existing Directory'. Clicking on this option will open up a new window. Click on 'Browse...' to navigate to the folder where you intend to save all your work related to @DabrowskaExperienceAptitudeIndividual2019. If you followed my suggestions earlier on, this would be a folder called something along the lines of `Dabrowska2019`. Once you have selected the correct folder, select the option 'Open in a new session' and then click on 'Create Project'.

![New project window](images/RStudioNewProject.png){#fig-RStudioNewProject fig-alt="New Project Wizard for Create Project from Existing Directory R Project. It shows the working directory: .../Documents/DataLiteracyTextbook/Dabrowska2019. There are three buttons: Browse..., Create Project and Cancel" width="440"}
...
![Contents of the project folder as displayed by RStudio](images/WorkingDirectory.png){#fig-WorkingDirectory fig-alt="Screenshot of the Files pane of RStudio showing the contens of a folder entitled 'Dabrowska2019'. It contains an RProject file called 'Dabrowska2019.Rproj' and '.Rhistory', a folder called 'analysis' and another folder called 'data'." width="440"}
...
![Selecting the import method of the dataset](images/RStudioReadrDatasetImport.png){#fig-RStudioReadrDatasetImport fig-alt="Screenshot of the Environment pane of RStudio showing the options to import a dataset. The option to import from text with the {readr} import functions is highlighted. Clicking on this opens the 'Import Text Data'-dialogue." width="440"}
