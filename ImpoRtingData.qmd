...
Here, we can see that the data has been correctly imported as a table. The commas have been correctly converted to decimal points and the empty cells are now labelled `NA`.[^importingdata-3]
