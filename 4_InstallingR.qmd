...
#### *"I am studying a language/linguistics so why should I learn to code?"* 🤔 {.unnumbered}
...
`r emoji("check-mark-button")`️ If you see the plot above, you have successfully installed and tested `R` and you can go on to installing RStudio.
...
::: {.callout-note collapse="false"}
#### Solving package installation problems `r emoji("double-exclamation-mark")`
...
Once you have successfully completed all the steps outlined in this chapter, you are ready to get sta`R`ted with [Chapter 5](https://elenlefoll.github.io/RstatsTextbook/5_GettingStaRted.html), which provides a hands-on introduction to `R` in *RStudio*. `r emoji("nerd-face")`
