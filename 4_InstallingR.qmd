...
[**Q4.4**]{style="color:green;"} Which is the correct `R` object name to access Jane Austern's novel 'Sense and Sensibility'?
...
[**Q4.5**]{style="color:green;"} What is the source for the `R` object containing Jane Austern's novel 'Sense and Sensibility'?
...
[**Q4.6**]{style="color:green;"} What is the first word of the 66^th^ line in the `R` object containing Jane Austern's novel 'Sense and Sensibility'?
...
You have successfully completed [`r checkdown::insert_score()` out of 6 quiz questions]{style="color:green;"} in this chapter.
