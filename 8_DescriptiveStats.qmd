...
[**Q5.**]{style="color:green;"} Which of the following statements is true?
...
[**Q6.**]{style="color:green;"} Which measure of central tendency best describes L1 participants' ages?
...
[**Q7.**]{style="color:green;"} What can we reasonably deduce from the distribution of L1 participants' ages visualised in @fig-L1AgeDensityPlot?
...
[**Q8.**]{style="color:green;"} What are the pros of reporting the median rather than the mean to describe the central tendency of a variable?
...
[**Q9.**]{style="color:green;"} What are the cons of reporting the median rather than the mean to describe the central tendency of a variable?
...
![The interquartile range in five different sets of values (CC-BY Elen Le Foll)](images/quartiles.gif){#fig-MakingIQR}
...
![The making of a boxplot (CC-BY Elen Le Foll)](images/boxplot.gif){#fig-MakingBoxplot}
...
[**Q10.**]{style="color:green;"} Examine the boxplots displayed in @fig-NormalBoxplots.
...
[**Q11.**]{style="color:green;"} The boxplots in @fig-NormalBoxplots are based on the same data as the three density plots in @fig-3NormalDistributions. Compare the two figures. Which distribution corresponds to which boxplot?
...
[**Q12.**]{style="color:green;"} Examine the following distribution of scores on the grammatical comprehension test administered as part of @DabrowskaExperienceAptitudeIndividual2019.
...
[**Q13.**]{style="color:green;"} Compare the following outputs of the `summary()` function.
...
[**Q14.**]{style="color:green;"} Compare the following boxplots which summarise the distribution of scores on the grammatical comprehension test (`GrammarR`) administered as part of @DabrowskaExperienceAptitudeIndividual2019.
...
Distribution C (@fig-DensityC) is a normal distribution with a mean of 35 years (x̅ = 35) and a standard deviation of 10 years (sd = 1).
...
[**Q15.**]{style="color:green;"} What is the standard deviation of L1 participants' age in @DabrowskaExperienceAptitudeIndividual2019? Calculate the sample standard deviation to two decimal places.
...
[**Q16.**]{style="color:green;"} Compare the standard deviation of the `Age` variable in the L1 and L2 datasets. What can you conclude on the basis of this comparison?
