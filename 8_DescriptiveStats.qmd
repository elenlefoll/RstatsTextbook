...
::: {.content-visible when-format="pdf"}
- Distribution A in @fig-3NormalDistributions is a normal distribution with a mean of 35 years (x̅ = 35) and a standard deviation of one year (sd = 1).
- Distribution B is also a normal distribution with a mean of 35 years (x̅ = 35d), but a larger standard deviation of 5 years (sd = 5).
- Distribution C is also a normal distribution with a mean of 35 years (x̅ = 35) and an even larger standard deviation of 10 years (sd = 10).
:::
...
::: {.content-visible when-format="html"}
In this respect, boxplots are more informative (compare the above SDs with @fig-GrammarRBoxplots). To evaluate the full shape of a numeric variable's distribution, however, it is best to plot the full distribution as a histogram or density plot.
:::
...
As a follow-up, I highly recommend reading this short and highly accessible [article](https://medium.com/data-science/a-visual-interpretation-of-the-standard-deviation-30f4676c291c) by Fahd @alhazmiVisualInterpretationStandard2020, who provides a beautiful visual guide to understanding standard deviation.
:::
