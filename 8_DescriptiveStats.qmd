...
::: {.content-visible when-format="pdf"}
![Screenshot of [animation](https://elenlefoll.github.io/RstatsTextbook/images/quartiles.gif) showing the interquartile range of five different sets of values (CC BY 4.0 Elen Le Foll <https://doi.org/10.5281/zenodo.17440319>)](images/GifCh8a.png){fig-alt="Still of an animation showing the interquartile range of different sets of values. The set of values are listed in one column and aligned at their respective medians. The first and third quartiles are highlighted and the range between them is labeled interquartile range."}
:::
