...
:::: {.content-visible when-format="pdf"}
### Check your progress {.unnumbered}
It's time to complete this chapter's [tasks and quizzes](https://elenlefoll.github.io/RstatsTextbook/8_quiz.html). They will give you more opportunities to explore the datasets from @DabrowskaExperienceAptitudeIndividual2019, ensuring that you are ready to then tackle data wrangling, visualisation, and inferential statistics!
::::
