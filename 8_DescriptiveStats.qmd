...
#| fig-width: 8
#| fig-height: 5
#| fig-alt: "This is the same bar plot as above. The only difference is that the mean is marked by a blue dashed line and it corresponds to the number 32.72 on the x-axis."
...
You have successfully completed [`r checkdown::insert_score()` out of 16 quiz questions]{style="color:green;"} in this chapter.
