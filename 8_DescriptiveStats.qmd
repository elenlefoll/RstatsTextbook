...
#| fig-alt: "Two bar plots of languages spoken by L1 participants for female and male participants. The distribution of additional languages is similar in both genders."
...
#| fig-width: 8
#| fig-height: 5
#| fig-alt: "Bar plot of the distribution of L2 participants’ ages. The y-axis is the number of L2 participants and the x-axis is age. A single bar corresponding to number 28 on the x-axis is highlighted as the mode for having the highest number of participants. Three highest bars after that are corresponding to numbers 22, 31, and 39 on the x-axis."
...
#| fig-width: 8
#| fig-height: 5
#| fig-alt: "The bar plot above. In addition to the bar representing mode, a single bar is highlighted in red as the median and it corresponds to the number 31 on the x-axis."
...
![Animation showing the interquartile range of five different sets of values ([CC-BY](https://creativecommons.org/licenses/by/4.0/) Elen Le Foll)](images/quartiles.gif){#fig-MakingIQR}
...
![Animation showing the making of a boxplot ([CC-BY](https://creativecommons.org/licenses/by/4.0/) Elen Le Foll)](images/boxplot.gif){#fig-MakingBoxplot}
