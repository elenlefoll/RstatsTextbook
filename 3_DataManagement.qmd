...
![Screenshot of a Finder window showing a hierarchical folder structure](images/FinderWindowPaths.png){#fig-FinderWindowPath fig-alt="Screenshot of a Finder Window showing path to a highlighted file. These next few quiz questions are not suitable for users of screenreaders."}
