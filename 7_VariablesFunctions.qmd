...
[**Q3.**]{style="color:green;"} Which type of variable is the variable `Occupation` in `L1.data`?
...
[**Q4.**]{style="color:green;"} Which type of variable is the variable `Gender` in `L1.data`?
...
[**Q5.**]{style="color:green;"} Which type of variable is the variable `VocabR` in `L1.data`?
...
[**Q6.**]{style="color:green;"} Use the `str()` function to examine the internal structure of the L2 dataset. How many variables are there in the L2 dataset?
...
[**Q7.**]{style="color:green;"} Which of these variables can be found in the L2 dataset, but not the L1 one?
...
[**Q8.**]{style="color:green;"} Which type of `R` object is the variable `Arrival` stored as?
...
[**Q9.**]{style="color:green;"} How old was the third participant listed in the L2 dataset when they first moved to an English-speaking country?
...
### Accessing individual variables in `R`
...
## Accessing individual data points in `R`
...
[**Q10.**]{style="color:green;"} Use the index operators to find out the native language of the 26^th^ L2 participant.
...
[**Q11.**]{style="color:green;"} Which command(s) can you use to display only the Gender, Occupation, Native language, and Age of the last participant listed in the L2 dataset?
...
[**Q12.**]{style="color:green;"} How does the average age of the L2 participants in @DabrowskaExperienceAptitudeIndividual2019 compare to that of the L1 participants?
...
[**Q13.**]{style="color:green;"} Based on your observations, what does the `round()` function do?
...
[**Q14.**]{style="color:green;"} Check out the 'Usage' section of the help file on the `round()` function to find out how to round the `Vocab` values in the L1 dataset to two decimal places. How can this be achieved?
...
[**Q15.**]{style="color:green;"} Using the `R` pipe operator, calculate the average mean age of the L2 participants and round off this value to two decimal places. What is the result?
