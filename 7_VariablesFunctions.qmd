...
You have successfully completed [`r checkdown::insert_score()` out of 17 quiz questions]{style="color:green;"} in this chapter.

Are you confident that you can...?

-   [ ] Inspect a data set in `R` (@sec-InspectData)
-   [ ] Recognise different types of variables and how to work with them (@sec-Variables)
-   [ ] Access individual columns and data points in `R` (@sec-DollarSign) - (@sec-SquareBrackets)
-   [ ] Use the built-in R functions and change function arguments (@sec-RFunctions)
-   [ ] Combine functions in `R` using nesting and piping methods (@sec-Nesting) - (@sec-Piping)
