...
[**Q3.**]{style="color:green;"} Which type of variable is stored in the `Occupation` column in `L1.data`?
...
[**Q4.**]{style="color:green;"} Which type of variable is stored in the `Gender` column in `L1.data`?
...
[**Q5.**]{style="color:green;"} Which type of variable is stored in the column `VocabR` in `L1.data`?
...
[**Q6.**]{style="color:green;"} Use the `str()` function to examine the internal structure of the L2 dataset. How many columns are there in the L2 dataset?
...
[**Q7.**]{style="color:green;"} Which of these columns can be found in the L2 dataset, but not the L1 one?
...
[**Q10.**]{style="color:green;"} In both datasets, the column `Participant` contains an anonymous participant ID. Why is the variable `Participant` stored as a string character in `L1.data`, but as an integer in `L2.data`?
...
check_question("Because some of the L1 participants' IDs contain letters as well as numbers.",
               options = c("Because some of the L1 participants' IDs contain letters as well as numbers.",
                           ...
                           "Because the L1 participants' ID only contain whole numbers with no decimal points.",
                           "Because the L1 participants' ID are written out as words rather than digits."), 
               type = "check",
button_label = "Check answer",
random_answer_order = TRUE,
...
### Accessing individual columns in `R`
...
[**Q11.**]{style="color:green;"} Use the index operators to find out the native language of the 26^th^ L2 participant.
...
[**Q12.**]{style="color:green;"} Which command(s) can you use to display only the Gender, Occupation, Native language, and Age of the last participant listed in the L2 dataset?
...
[**Q13.**]{style="color:green;"} How does the average age of the L2 participants in @DabrowskaExperienceAptitudeIndividual2019 compare to that of the L1 participants?
...
[**Q14.**]{style="color:green;"} Based on your observations, what does the `round()` function do?
...
[**Q15.**]{style="color:green;"} Check out the 'Usage' section of the help file on the `round()` function to find out how to round the `Vocab` values in the L1 dataset to two decimal places. How can this be achieved?
...
[**Q16.**]{style="color:green;"} Using the `R` pipe operator, calculate the average mean age of the L2 participants and round off this value to two decimal places. What is the result?
