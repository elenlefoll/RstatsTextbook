...
-   Francom, Jerid. 2025. *An Introduction to Quantitative Text Analysis for Linguistics: Reproducible Research Using R*. London: Routledge. <https://doi.org/10.4324/9781003393764>. `Open Access`.
...
-   Sonderegger, Morgan. 2023. Regression modeling for linguistic data. Cambridge, Massachusetts: The MIT Press. `[Open Access version](https://github.com/msonderegger/rmld-v1.1/blob/main/rmld_v1.1.pdf)`.
