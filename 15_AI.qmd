...
::: {.content-visible when-format="pdf"}
### Check your progress {.unnumbered}
This chapter's interactive [tasks and quizzes](https://elenlefoll.github.io/RstatsTextbook/15_quiz.html) encourage you to continue reflecting on the impact of AI in research and learning. Perhaps you'd like to complete them with a friend or colleague? `r emoji("hugs")`
:::
