...
![Happy learning and good luck with all your data analysis p`R`ojects!️ <br>Artwork by [\@allison_horst](https://allisonhorst.com/r-packages-functions) CC BY 4.0](images/AHorst_RFlowers.png){fig-alt="Two cute little monsters decorating the R logo with hearts, flowers, and smilies." width=70%}
:::

::: {.content-visible when-profile="LSP"}
![Happy learning and good luck with all your data analysis p`R`ojects! Artwork [\@allison_horst](https://allisonhorst.com/r-packages-functions) CC BY 4.0](images/AHorst_RFlowers.png){fig-alt="Two cute little monsters decorating the R logo with hearts, flowers, and smilies." width=60%}
:::
