...
[**Q15.1**]{style="color:green;"} Which of the following analogies have (rightly or wrongly) been used by different scholars to refer to Large Language Models (LLMs)?
...
check_hint("Six of the above analogies have been used to describe LLMs by academics and scholars. If you have not heard of them yet, click on the tab below to find out more about these metaphors.", 
...
-   Guest, Olivia, Marcela Suarez, Barbara Müller, Edwin van Meerkerk, Arnoud Oude Groote Beverborg, Ronald de Haan, Andrea Reyes Elizondo, et al. 2025. Against the Uncritical Adoption of “AI” Technologies in Academia. Zenodo. <https://zenodo.org/records/17065099>. \[Open Access\].
    ...
    `r emoji("arrow_right")` See also Olivia Guest's curated list of readings on critical AI literacy: <https://olivia.science/ai/> \[Open Access\].
