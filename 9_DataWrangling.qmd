...
`r emoji("ringed_planet")` Note that this a {tidyverse} approach to working out percentages, see @sec-Mode for a base `R` approach.
...
This is a reminder to *always* check whether your data wrangling operations have gone as planned. Just because you didn't get an error message doesn't mean that your code did what you wanted! `r emoji("warning")`️
:::
::::
