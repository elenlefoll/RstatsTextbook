...
#| fig-alt: "Graphic with four boxes corresponding to the 4 main stages of the lifecycle of 'R' packages. From left to right, one arrow leads from 'experimental' to 'stable', and two arrows lead from 'stable' to 'deprecated' and 'superceded'."
