...
::: {.callout-note collapse="true"}
#### Click here for solutions to Task 9.3
...
#### Click here to see the `R` code necessary to answer [**Q9.5**]{style="color:green;"} {#sec-filter}
...
You have successfully completed [`r checkdown::insert_score()` out of 5 questions]{style="color:green;"} in this chapter.
...
The [following chapter](https://elenlefoll.github.io/RstatsTextbook/10_Dataviz.html) stays in the tidyverse as we will learn how to use the popular tidyverse package {ggplot2} to visualise the pre-processed data from @DabrowskaExperienceAptitudeIndividual2019.
