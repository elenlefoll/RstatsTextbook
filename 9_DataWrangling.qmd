...
#### Click here for `R` code to answer {#sec-filter} [**Q5.**]{style="color:green;"}
...
You have successfully completed [`r checkdown::insert_score()` out of 15 quiz questions]{style="color:green;"} in this chapter.
