...
## Welcome to the tidyverse! `r emoji("ringed-planet")` {#sec-tidyverse}
...
```{r collapse=TRUE}
#| code-fold: true
#| code-summary: "Click here to help you answer **a.**"
#| echo: true
...
>
> ## Extract words from a sentence {.unnumbered}
>
...
#### Going further: Using regular expressions (regex) `r emoji("nerd-face")`
...
#### What if my data are not yet in tidy format? `r emoji("face-with-raised-eyebrow")`
...
check_question(c("6"),
               ...
               button_label = "Check answer",
               q_id = "Q9.15", 
               right = "That's right! Check the solution below to see different ways to find the answer to this question. `r emoji(\"smiling-face-with-sunglasses\")`",
...
+:================================================================================================+:========================================================================================================================================+
| `r emoji("check-mark-button")` Highly portable (i.e., can be opened in all standard spreadsheet software and text editors). | `r emoji("cross-mark")` Specific to `R` and cannot be opened in standard spreadsheet software or text editors.                                               |
+-------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
| `r emoji("cross-mark")` Inefficient for very large datasets.                                                         | `r emoji("check-mark-button")` Efficient memory usage for more compact data storage and faster loading times in `R`.                                                |
+-------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
| `r emoji("check-mark-button")` Universal, language-independent format and therefore suitable for long-term archiving.       | `r emoji("cross-mark")` No guarantee that older `.rds` files will be compatible with newer versions of `R` and therefore unsuitable for long-term archiving. |
+-------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
| `r emoji("cross-mark")` Loss of metadata.                                                                            | `r emoji("check-mark-button")` Preserve `R` data structures (e.g., factor variables remain stored as factors).                                                      |
+-------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------+
...
In @sec-DataViz we continue to explore the tidyverse as we learn how to use the popular tidyverse package {ggplot2} to visualise the pre-processed data from @DabrowskaExperienceAptitudeIndividual2019. Are you ready to get creative? `r emoji("artist-palette")`
