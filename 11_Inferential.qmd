...
check_question(c("All three differences in means are statistically significant at the α-level of 0.01.",
               ...
               button_label = "Check answer",
               right = "Correct!",
               wrong = "No, not quite. Two of these statements are correct and you need to select both to get this question right.")
...
Clearly, if we had only used correlation statistics to describe the relationships between these 13 pairs of variables, we would have missed some literally dinosaur-sized patterns! `r emoji("exploding-head")`
:::
