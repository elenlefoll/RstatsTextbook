...
::: callout-note
# Reporting statistical results
To summarise these results, we can write that, in this dataset, there is a small positive and statistically significant correlation between the number of years that participants reported spending in formal education and their receptive English vocabulary test scores, *r* = 0.1344, df = 65, *p* = 0.2782.
:::
