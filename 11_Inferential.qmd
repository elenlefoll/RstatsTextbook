...
check_question("4.6768",
               ...
               right = "Correct!",
               wrong = "Incorrect.")
check_hint("As a reminder, the results of the English receptive vocabulary test are stored in the `Vocab` variable amd the distinction between the L1 and the L2 participants' results is made in the `Group` variable so these are the two variables that will need to be entered in the `t.test()` formula.", 
