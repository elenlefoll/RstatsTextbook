...
### Homogeneity of variance {#sec-Homoscedasticity}
...
-   Check that the main underlying assumptions of statistical tests (@sec-Assumptions) are met:
    -   [ ] randomisation (@sec-Randomisation)
    -   [ ] independence (@sec-Independence)
    -   [ ] normality (@sec-Normality)
    -   [ ] linearity (@sec-Linearity)
    -   [ ] homoscedasticity (@sec-Homoscedasticity).
