...
\![Remember that the best way to check test assumptions is to visualise your data! (artwork by [Allison Horst](https://twitter.com/allison_horst) ([CC BY 4.0](https://creativecommons.org/licenses/by/4.0/))(images/AHorst_NotNormal.png){#fig-NotNormal fig-alt="Cartoon of a normal distribution looking skeptically at an excited looking bimodal / negatively skewed distribution. The first says to the second, "you're not normal."" width="448"}
